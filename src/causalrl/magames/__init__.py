...
certificate; :func:`certify_equilibrium` certifies (robust, possibly intervened) equilibria with an
honest epistemic ``Kind`` capped by the :class:`LearnerTopology` (I2).
