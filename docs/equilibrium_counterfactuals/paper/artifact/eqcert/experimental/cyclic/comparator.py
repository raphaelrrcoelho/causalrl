...
:class:`~eqcert.certify.certificate.Certificate`:
...
:func:`~eqcert.scm.unrolled.build_unrolled_scm` is scalar-per-node --
...
from eqcert.experimental.cyclic.scm import FloatArray, LinearCyclicSCM
