...
:class:`~eqcert.protocols.CausalEnvProtocol` (``sample`` / ``do`` producing a
:class:`~eqcert.data.trajectory.TrajectoryLog`), so the Phase-1 estimation machinery applies to it
...
from eqcert.data.trajectory import TrajectoryLog
from eqcert.protocols import NoiseLedger
from eqcert.regime import Regime
