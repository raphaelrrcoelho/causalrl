...
:class:`~causalrl.games.CausalGame`, optionally **under an intervention** ``do`` that fixes some
...
from causalrl.magames.population import LearnerTopology, topology_max_kind
