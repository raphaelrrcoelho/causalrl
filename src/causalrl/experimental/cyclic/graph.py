...
The shipped :class:`causalrl.scm.graph.CausalGraph` is acyclic by construction. Feedback systems --
...
class CyclicCausalGraph:
    ...
    Unlike :class:`~causalrl.scm.graph.CausalGraph` this imposes **no acyclicity constraint**. Use
