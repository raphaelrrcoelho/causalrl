...
:func:`causalrl.identification._separation.d_separated` makes the acyclic-coincidence guarantee
...
def sigma_separated(
    ...
    :func:`~causalrl.identification._separation.d_separated` returns for the same edges -- the
