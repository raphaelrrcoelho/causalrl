...
For a population of no-regret learners playing a finite :class:`~eqcert.games.CausalGame`,
...
from eqcert.identification.bounds import Interval
from eqcert.magames._lp import FloatArray, solve_lp
