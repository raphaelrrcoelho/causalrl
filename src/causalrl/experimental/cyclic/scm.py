...
equilibrium-vs-unrolling comparator (:mod:`causalrl.experimental.cyclic.comparator`) checks.
"""
...
from causalrl.certify.certificate import Hedge
...
class CyclicSolveError(CausalRLError):
