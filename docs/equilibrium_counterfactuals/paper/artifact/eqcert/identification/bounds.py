...
from eqcert.data.dataset import ConfoundedTrajectoryDataset
from eqcert.exceptions import NotIdentifiableError

if TYPE_CHECKING:
    from eqcert.certify.certificate import Certificate
...
def ipw_sensitivity_bounds(
    ...
    *,
    ...
    if return_certificate is None:
        return_certificate = True  # eqcert 2.0: return a Certificate by default
    if return_certificate:
        from eqcert.certify.routines import ipw_sensitivity_bounds_certified
...
def msm_policy_value_bounds(
    ...
    *,
    ...
    if return_certificate is None:
        return_certificate = True  # eqcert 2.0: return a Certificate by default
    if return_certificate:
        from eqcert.certify.routines import msm_policy_value_bounds_certified
