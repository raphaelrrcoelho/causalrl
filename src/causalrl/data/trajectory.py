...
lossless two-way bridge with the shipped :class:`~causalrl.data.dataset.ConfoundedTrajectoryDataset`
...
_MISSING = "TrajectoryLog Arrow/Parquet IO requires pyarrow; install the 'causalrl[data]' extra"
...
class TrajectoryLog:
    ...
    def to_arrow(self) -> Any:
        ...
        meta = {b"causalrl_metadata": json.dumps(self._metadata).encode("utf-8")}
    ...
    def from_arrow(cls, table: Any) -> TrajectoryLog:
        ...
        raw = schema_meta.get(b"causalrl_metadata") if schema_meta else None
